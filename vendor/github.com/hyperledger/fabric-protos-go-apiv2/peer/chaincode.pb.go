...
type ChaincodeAdditionalParams struct {
	...
	UsePutStateBatch     bool   `protobuf:"varint,1,opt,name=use_put_state_batch,json=usePutStateBatch,proto3" json:"use_put_state_batch,omitempty"`               // an indication that the peer can handle state change batches
	MaxSizePutStateBatch uint32 `protobuf:"varint,2,opt,name=max_size_put_state_batch,json=maxSizePutStateBatch,proto3" json:"max_size_put_state_batch,omitempty"` // maximum size of batches with changed state
}
...
func (x *ChaincodeAdditionalParams) GetUsePutStateBatch() bool {
	if x != nil {
		return x.UsePutStateBatch
	}
	return false
}

func (x *ChaincodeAdditionalParams) GetMaxSizePutStateBatch() uint32 {
	if x != nil {
		return x.MaxSizePutStateBatch
	}
	return 0
}
...
var file_peer_chaincode_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x2d, 0x67, 0x6f, 0x2d, 0x61, 0x70, 0x69, 0x76, 0x32, 0x2f, 0x70, 0x65, 0x65, 0x72, 0xa2,
	0x02, 0x03, 0x50, 0x58, 0x58, 0xaa, 0x02, 0x06, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0xca, 0x02,
	0x06, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0xe2, 0x02, 0x12, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73,
...
func file_peer_chaincode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_peer_chaincode_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
