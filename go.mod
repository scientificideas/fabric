...
replace github.com/hyperledger/fabric-protos-go => gitlab.n-t.io/ntbc/fabric-protos-go v0.0.0-20201111140158-788146987163
...
require (
	...
	github.com/SmartBFT-Go/consensus v0.0.0-20200305092142-48c132f58ce8
