...
type Handler struct {
	...
	// UsePutStateBatch an indication that the peer can accept changes from chaincode in batches
	UsePutStateBatch bool
	// MaxSizePutStateBatch maximum batch size for the change segment
...
func (h *Handler) sendReady() error {
	...
	chaincodeAdditionalParams := &pb.ChaincodeAdditionalParams{
		UsePutStateBatch:     h.UsePutStateBatch,
		MaxSizePutStateBatch: h.MaxSizePutStateBatch,
	}
