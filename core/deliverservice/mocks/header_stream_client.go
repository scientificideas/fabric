...
func (_m *HeaderStreamClient) Context() context.Context {
	ret := _m.Called()
...
func (_m *HeaderStreamClient) Header() (metadata.MD, error) {
	ret := _m.Called()
...
func (_m *HeaderStreamClient) RecvMsg(m interface{}) error {
	ret := _m.Called(m)
...
func (_m *HeaderStreamClient) SendMsg(m interface{}) error {
	ret := _m.Called(m)
...
func (_m *HeaderStreamClient) Trailer() metadata.MD {
	ret := _m.Called()
